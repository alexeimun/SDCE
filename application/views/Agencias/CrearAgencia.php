...
<div class="container">
    ...
    <?= form_input(['placeholder' => 'Ingrese el nombre de la agencia', 'name' => 'NOMBRE_AGENCIA', 'class' => 'obligatorio', 'label' => ['text' => 'Nombre']]) ?>
    <?= form_input(['placeholder' => 'Ingrese el correo electrónico de la agencia', 'name' => 'CORREO_AGENCIA', 'class' => 'correo', 'label' => ['text' => 'Correo']]) ?>
...
<script>
    ...
    function Save() {
        $.ajax({
            type: 'post', url: 'crearagencia', data: $('form').serialize(),
            beforeSend: function () {
                $('body').addClass('Wait');
