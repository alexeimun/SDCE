    ...
    <div class="row">
        <div class="col-xs-12">
            <div class="box">
                ...
                <div class="box-body">
                    <?= TablaCierre(['columns' => ['Nombre estudiante', 'Agencia', 'Tema', 'Paz y salvo empresa', 'Paz y salvo asesor en el cd', 'Formato de evaluación'],
                        'tableName' => 'practicante', 'id' => 'ID_PRACTICANTE','autoNumeric'=>true,
                        'fields' => ['NOMBRE_PRACTICANTE', 'NOMBRE_AGENCIA', 'NOMBRE_PROYECTO', 'CHECKBOX', 'CHECKBOX', 'CHECKBOX'], 'dataProvider' => $this->practicantes_model->TraePracticantes()]) ?>
                </div>
...
<script type="text/javascript">
    ...
    $(function () {
        ...
        function ArmarTabla() {
            var nombre = 'Cierra prácticas - Admisiones<?=date('d-m-Y') ?>';
            Pulir([5, 6, 7]);
