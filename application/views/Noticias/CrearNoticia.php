...
<section class="content-header">
    <?= page_title(['ob' => $this, 'class' => 'fa fa-newspaper-o', 'text' => 'Crear Noticia']) ?>
</section>
<!-- Main content -->
<div class="container">
    <?= form_open('seguimiento/pazysalvo', ['class' => 'form-horizontal col-md-10', 'target' => '_blank', 'style' => 'margin-left: 8%']) ?>
    ...
    <br><br>
    <!--Envíar-->
    <?= input_submit(['class' => 'col-lg-offset-5 col-lg-10', 'text' => 'Enviar noticia']) ?>
    <?= br(2) ?>
</div>
