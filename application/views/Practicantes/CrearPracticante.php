...
<div class="container">
    ...
    <?= form_input(['placeholder' => 'Ingrese el nombre completo del practicante', 'name' => 'NOMBRE_PRACTICANTE', 'class' => 'obligatorio', 'label' => ['text' => 'Nombre']]) ?>
    ...
    <?= form_input(['placeholder' => 'Ingrese el número de celular', 'name' => 'CELULAR', 'class' => 'numero telefono', 'label' => ['text' => 'Celular']]) ?>
    <?= form_dropdown('ID_PROGRAMA', [1 => 'Ingeniería de sistemas', 2 => 'Ingeniería de software', 3 => 'Electromedicina', 4 => 'Robótica y automatización'], ['label' => ['text' => 'Programa']]) ?>
